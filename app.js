...
function renderStaff(){
  ...
  view.innerHTML=`<section class="panel"><h2>จำนวนพยาบาล</h2>
    ...
    <span class="status">แตะช่องวันที่เพื่อบันทึกวันขอหยุด เลือกได้ทั้งวันหรือเฉพาะเวร ช / บ / ด ช่อง "สูงสุด" คือจำนวนเวรมากที่สุดที่คนนั้นรับได้ในเดือน (เว้นว่าง = ไม่จำกัด)</span></div>
